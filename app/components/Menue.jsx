...
const Menue = () => {
  return (
    <div className="menue w-full">
      <div className="bg-white mx-auto border w-11/12 flex flex-col shadow-current justify-center items-center my-12 py-12">
        <h4 className="text-5xl font-semibold text-center">Online Menu</h4>
        <p className="text-xl my-8 text-center px-4 sm:px-2 md:px-0">
